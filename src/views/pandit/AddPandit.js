...
const AddPandit = () => {
  ...
  const token ='Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IlNoaXZhbnNodSIsImlhdCI6MTczMjE2NTMzOX0.YDu6P4alpQB5QL-74z1jO4LGfEwZA_n_Y29o512FrM8';; // Replace with your actual token
  ...
  const handleFormSubmit = (e) => {
    ...
    fetch('http://localhost:3000/api/pandit/create-pandit', {
      method: 'POST',
      headers: {
        'Authorization': token,
      },
    ...
    <div className="col-12">
      <div className="card shadow-lg mb-4 border-0">
        <div className="card-header text-left bg-dark text-white">
          <h6 className="text-Capitalize">Add New Pandit</h6>
        </div>
 ...
 <label className="form-label">Pincode</label>
            ...
            <div className="col-md-6 mb-3">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, bank_ac_no: e.target.value })}
              />
            </div>
            <div className="col-md-6 mb-3">
            ...
            <div className="col-md-6 mb-3">
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, pancard_no: e.target.value })}
              />
            </div>
            <div className="col-md-6 mb-3">
